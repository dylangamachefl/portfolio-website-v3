        ...
        <main className="pb-12 pt-2">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <FadeIn delay={200} className="h-full">
                  <div className="group relative overflow-hidden rounded-lg min-h-[200px] h-full shadow-sm cursor-pointer">
                    <img 
                      ...
                      src="/things-to-do-in-bradenton-Cover.jpg" 
                    />
            ...
            <div className="flex flex-col gap-8 h-full">
              ...
              {/* AI Assistant - Fixed height of 700px to ensure it spans sufficiently without expanding indefinitely */}
              <FadeIn direction="left" delay={400} className="h-[727px]">
                <AiAssistant />
              </FadeIn>
          ...
          <section className="mt-16">
            <FadeIn>
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
                 ...
                 <a className="text-sm font-medium text-primary hover:underline flex items-center shrink-0 group transition-all" href="#">
                  View All <span className="material-icons-outlined text-sm ml-1 group-hover:translate-x-1 transition-transform">arrow_forward</span>
                </a>
              </div>
            </FadeIn>
